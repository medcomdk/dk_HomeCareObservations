...
* definition 1..1 MS 
* definition obeys medcom-hcobs-definition-url

Invariant: medcom-hcobs-definition-url
Description: "SHALL reference a MedCom HomeCare Observation MessageDefinition whose canonical URL starts with
https://medcomfhir.dk/ig/messagedefinitions/MessageDefinition-MedComHomeCareObservationMessageDefinition1.—that is, any version 1.x of the message definition"
Expression: "matches('^http://medcomfhir.dk/ig/messagedefinitions/MessageDefinition/MedComHomeCareObservationMessageDefinition1[.][0-9]{1,2}$')"
Severity: #error
